...
You can use agents to setup custom system prompts with KIT. The server host can setup their own agents, which are accessible to all users. You can see ours at https://app.KIT.dev/agents.
