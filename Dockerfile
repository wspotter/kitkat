...
LABEL homepage="https://KIT.dev"
LABEL repository="https://github.com/KIT-ai/KIT"
LABEL org.opencontainers.image.source="https://github.com/KIT-ai/KIT"
...
ARG PORT=42110
EXPOSE ${PORT}
ENTRYPOINT ["python3", "src/kit/main.py"]
