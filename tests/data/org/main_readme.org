...
** Use
*** *KIT via Emacs*  [[https://KIT.dev][link to KIT website]]  :@EMACS:CLIENT_1:KIT:
     - [[https://github.com/KIT-ai/KIT/tree/master/interface/emacs#installation][Install]] [[./interface/emacs/KIT.el][KIT.el]]
     - Run ~M-x KIT <user-query>~ or Call ~C-c C-s~
...
*** *KIT via API*
     ...
     - [[http://localhost:42110/docs][KIT API Docs]]

*** *Call KIT via Python Script Directly*
     #+begin_src shell
