...
telemetry_server = "https://kit.beta.haletic.com/v1/telemetry"
content_directory = "~/.KIT/content/"
...
empty_config = {
    "search-type": {
        "image": {"encoder": "sentence-transformers/clip-ViT-B-32", "model_directory": "~/.KIT/search/image/"},
    },
}
