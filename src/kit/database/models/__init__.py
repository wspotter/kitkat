...
class GoogleUser(models.Model):
    user = models.OneToOneField(KITUser, on_delete=models.CASCADE)
...
class KITApiUser(models.Model):
    """User issued API tokens to authenticate KIT clients"""

    user = models.ForeignKey(KITUser, on_delete=models.CASCADE)
...
class Subscription(DbBaseModel):
    ...
    user = models.OneToOneField(KITUser, on_delete=models.CASCADE, related_name="subscription")
...
class Agent(DbBaseModel):
    ...
    creator = models.ForeignKey(
        KITUser, on_delete=models.CASCADE, default=None, null=True, blank=True
...
class PublicConversation(DbBaseModel):
    source_owner = models.ForeignKey(KITUser, on_delete=models.CASCADE)
    conversation_log = models.JSONField(default=dict)
    slug = models.CharField(max_length=200, default=None, null=True, blank=True)
...
class ReflectiveQuestion(DbBaseModel):
    ...
    user = models.ForeignKey(KITUser, on_delete=models.CASCADE, default=None, null=True, blank=True)
...
class DataStore(DbBaseModel):
    ...
    owner = models.ForeignKey(KITUser, on_delete=models.CASCADE, default=None, null=True, blank=True)
