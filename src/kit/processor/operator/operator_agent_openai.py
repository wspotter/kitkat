    ...
    def get_instructions(self, environment_type: EnvironmentType, current_state: EnvState) -> str:
        ...
        if environment_type == EnvironmentType.BROWSER:
            return dedent(
                f"""
                <SYSTEM_CAPABILITY>
                * You are KIT, a smart web browser operating assistant. You help the users accomplish tasks using a web browser.
            ...
            return dedent(
                f"""
                <SYSTEM_CAPABILITY>
                * You are KIT, a smart computer operating assistant. You help the users accomplish their tasks using a computer.
