...
class NotionToEntries(TextToEntries):
    ...
    def process(self, files: dict[str, str], user: KITUser, regenerate: bool = False) -> Tuple[int, int]:
        current_entries = []
    ...
    def update_entries_with_ids(self, current_entries, user: KITUser = None):
