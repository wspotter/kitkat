...
from kit.utils.helpers import is_env_var_true
...
KIT_ALLOWED_DOMAIN = os.getenv("KIT_ALLOWED_DOMAIN", KIT_DOMAIN)
ALLOWED_HOSTS = [f".{KIT_ALLOWED_DOMAIN}", "localhost", "127.0.0.1", "[::1]", f"{KIT_ALLOWED_DOMAIN}"]

# All Subdomains of KIT_DOMAIN are trusted for CSRF
...
DISABLE_HTTPS = is_env_var_true("KIT_NO_HTTPS")

# WARNING: Change this check only if you know what you are doing.
if not os.getenv("KIT_DOMAIN"):
    SESSION_COOKIE_DOMAIN = "localhost"
    CSRF_COOKIE_DOMAIN = "localhost"
else:
    # Production Settings
    SESSION_COOKIE_DOMAIN = KIT_DOMAIN
    CSRF_COOKIE_DOMAIN = KIT_DOMAIN
...
DB_NAME = os.getenv("POSTGRES_DB", "KIT")
...
# User Settings
AUTH_USER_MODEL = "database.KITUser"
...
UNFOLD = {
    "SITE_TITLE": "KIT Admin Panel",
    "SITE_HEADER": "KIT Admin Panel",
    "SITE_URL": "/",
    "SITE_ICON": {
        "light": lambda request: static("assets/icons/KIT_lantern_128x128.png"),
        "dark": lambda request: static("assets/icons/KIT_lantern_128x128_dark.png"),
    },
    "SITE_FAVICONS": [
        {
            "rel": "icon",
            "sizes": "32x32",
            "type": "image/svg+xml",
            "href": lambda request: static("assets/icons/KIT_lantern.svg"),
        },
    ],
}
