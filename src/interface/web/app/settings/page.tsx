...
import { KITLogoType } from "../components/logo/KITLogo";
        ...
        <Card className="grid grid-flow-column border border-gray-300 shadow-md rounded-lg dark:bg-muted dark:border-none border-opacity-50 lg:w-2/3">
            ...
            <CardContent className="overflow-hidden grid gap-6">
                <p className="text-md text-gray-400">
                    Access KIT from the{" "}
                    <a href="https://docs.KIT.dev/clients/desktop" target="_blank">
                        Desktop
                    </a>
                    , <a href="https://docs.KIT.dev/clients/obsidian">Obsidian</a>,{" "}
                    <a href="https://docs.KIT.dev/clients/emacs">Emacs</a> apps and more.
                </p>
                <Table>
                    <TableBody>
                        {apiKeys.map((key) => (
                                        ...
                                        <Copy
                                            ...
                                            onClick={() => {
                                                toast({
                                                    ...
                                                    description: `Set this API key in the KIT apps you want to connect to this KIT account`,
                                                });
                                        ...
                                        <Trash
                                            ...
                                            onClick={() => {
                                                toast({
                                                    ...
                                                    description: `Apps using this API key will no longer connect to this KIT account`,
                                                });
...
export default function SettingsView() {
    ...
    const sendOTP = async () => {
        try {
            ...
            toast({
                title: "📱 Phone",
                description: "Failed to send OTP. Try again or contact us at team@KIT.dev",
            });
        }
    };
    ...
    const verifyOTP = async () => {
        try {
            ...
            toast({
                title: "📱 Phone",
                description: "Failed to verify OTP. Try again or contact us at team@KIT.dev",
            });
        }
    };
    ...
    const disconnectNumber = async () => {
        try {
            ...
            toast({
                title: "📱 Phone",
                description:
                    "Failed to disconnect phone number. Try again or contact us at team@KIT.dev",
            });
        }
    };
    ...
    const setSubscription = async (state: string) => {
        try {
            ...
            toast({
                ...
                description:
                    state === "cancel"
                        ? "Failed to cancel subscription. Try again or contact us at team@KIT.dev"
                        : "Failed to renew subscription. Try again or contact us at team@KIT.dev",
            });
        }
    };
    ...
    const saveName = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "Failed to update name. Try again or contact team@KIT.dev",
            });
        }
    };
    ...
    const exportChats = async () => {
        try {
            ...
            saveAs(content, "KIT-conversations.zip");
    ...
    const saveNotionToken = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "Failed to save Notion API key. Try again or contact team@KIT.dev",
            });
        }
    };
    ...
    const handleToggleMemory = async (enabled: boolean) => {
        try {
            ...
            toast({
                ...
                description: enabled
                    ? "KIT will learn and remember from your conversations."
                    : "KIT will no longer learn or remember from your conversations.",
            });
        } catch (error) {
    ...
    const syncContent = async (type: string) => {
        try {
            ...
            toast({
                ...
                description: `Failed to sync ${type} content. Try again or contact team@KIT.dev`,
            });
        }
    };
        ...
        try {
            ...
            if (source === "computer") {
                ...
                toast({
                    ...
                    description: `Your ${source} integration to KIT has been disconnected.`,
                });
            }
        } catch (error) {
            ...
            toast({
                ...
                description: `Failed to disconnect from ${source}. Try again or contact team@KIT.dev`,
            });
        }
    };
                ...
                <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
                    ...
                    {isMobileWidth ? (
                        <a className="p-0 no-underline" href="/">
                            <KITLogoType className="h-auto w-16" />
                        </a>
                    ) : (
                                            ...
                                            <Card className={cardClassName}>
                                                ...
                                                <CardContent className="overflow-hidden">
                                                    <p className="pb-4 text-gray-400">
                                                        What should KIT refer to you as?
                                                    </p>
                                                    <Input
                                                        type="text"
                                                    ...
                                                    {(userConfig.subscription_state === "trial" && (
                                                        <>
                                                            ...
                                                            <p className="text-gray-400">
                                                                ...
                                                                day trial of the KIT Futurist plan.
                                                                Your trial ends on{" "}
                                                                {
                                                    ...
                                                    {(userConfig.subscription_state ==
                                                        ...
                                                        (
                                                            <Button
                                                                ...
                                                                onClick={() =>
                                                                    window.open(
                                                                        `${userConfig.KIT_cloud_subscription_url}?prefilled_email=${userConfig.username}`,
                                                                        "_blank",
                                                                        "noopener,noreferrer",
                                                                    )
                                                                }
                                                ...
                                                <CardContent className="grid gap-4">
                                                    ...
                                                    {!userConfig.notion_oauth_url && (
                                                        <Input
                                                            ...
                                                            value={notionToken || ""}
                                                            placeholder="Enter API Key of your KIT integration on Notion"
