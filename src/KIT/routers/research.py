...
from KIT.database.adapters import AgentAdapters, EntryAdapters, McpServerAdapters
from KIT.database.models import Agent, ChatMessageModel, KITUser, UserMemory
...
from KIT.processor.tools.mcp import MCPClient
from KIT.processor.tools.online_search import read_webpages_content, search_online
...
async def research(
    ...
    current_iteration = 0
    MAX_ITERATIONS = int(os.getenv("KIT_RESEARCH_ITERATIONS", 5))
