...
from KIT.database.adapters import AutomationAdapters, ConversationAdapters
from KIT.database.models import KITUser
from KIT.processor.conversation.utils import clean_json
from KIT.routers.helpers import schedule_automation, schedule_query
