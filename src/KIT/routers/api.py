...
from KIT.configure import initialize_content
from KIT.database import adapters
from KIT.database.adapters import ConversationAdapters, EntryAdapters, get_user_photo
from KIT.database.models import KITUser, SpeechToTextModelOptions, UserConversationConfig
from KIT.processor.conversation.openai.whisper import transcribe_audio
...
def update(
    ...
    return {"status": "ok", "message": "KIT reloaded"}
