...
from KIT.utils import config as utils_config
from KIT.utils.helpers import LRU, get_device, is_env_var_true
...
telemetry_disabled: bool = is_env_var_true("KIT_TELEMETRY_DISABLE")
...
billing_enabled: bool = (
    ...
    and os.getenv("KIT_CLOUD_SUBSCRIPTION_URL") is not None
)
